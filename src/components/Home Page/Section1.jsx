            ...
            <div className="section-container bg-[#0451cd] h-[90vh] w-full flex justify-between items-center">
                <div className="book-content w-full md:w-[50%] text-white flex flex-col items-center md:items-start md:gap-10 gap-20 md:px-10 px-20">
                    ...
                    {user && user.role === 'admin'
                        ?
                        <Link to={'/admin/appointments'} className='bg-white text-[#0451cd] text-center w-fit rounded-lg font-bold p-2 px-3 text-lg cursor-pointer'>Appointments</Link>
                        :
                        <Link to={'/booking'} className='bg-white text-[#0451cd] text-center w-fit rounded-lg font-bold p-2 px-3 text-lg cursor-pointer'>Book An Appointment</Link>
                    }
                </div>
